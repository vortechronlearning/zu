...
<head>
  ...
  <title>My Canned Drinks Ordering System : Customers</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
     ...
     <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="fname" type="text" class="form-control" id="customerfname" placeholder="Customer First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_fname']; ?>" required> 
      </div>
        </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="lname" type="text" class="form-control" id="customerlname" placeholder="Customer Last Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_lname']; ?>" required>
      </div>
        </div>
