...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a163495, tbl_staffs_a163495,
      tbl_customers_a163495, tbl_orders_details_a163495 WHERE
      ...
      tbl_orders_a163495.fld_order_id = tbl_orders_details_a163495.fld_order_id AND
      tbl_orders_a163495.fld_order_id = :oid");
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Marvelous Canned Drinks Sdn. Bhd.</h4>
      </div>
