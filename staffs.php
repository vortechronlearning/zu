...
<head>
  ...
  <title>My Canned Drinks Ordering System : Staff</title>
  <!-- Bootstrap -->
    ...
    <form action="staffs.php" method="post" class="form-horizontal">
      ...
      <input name="sid" type="text" class="form-control" id="staffid" placeholder="Staff ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_id']; ?>" required> 
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="fname" type="text" class="form-control" id="staffname" placeholder="Staff First Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_fname']; ?>" required>
       </div>
        </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="lname" type="text" class="form-control" id="stafflname" placeholder="Staff Last Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_lname']; ?>" required> 
      </div>
        </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="phone" type="text" class="form-control" id="customerphone" placeholder="Staff Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone']; ?>" required> 
       </div>
        </div>
      ...
      <input type="hidden" name="oldpid" value="<?php echo $editrow['fld_staff_id']; ?>">
